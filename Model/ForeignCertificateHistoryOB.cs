...
namespace Model
{
    ...
    /// </summary>
    [Serializable]
    public class ForeignCertificateHistoryOB
    {
        public ForeignCertificateHistoryOB()
        {
            //默认值
        }

        //主键
        protected long? _CertificateHistoryID;
        ...
        {
            get { return _CertificateHistoryID; }
            set { _CertificateHistoryID = value; }
        }
