...
{
	/// <summary>
	/// 业务实体类--zjs_ApplyChangeMDL填写类描述
	/// </summary>
	[Serializable]
	public class zjs_ApplyChangeMDL
	{
		public zjs_ApplyChangeMDL()
		{			
		}
		...
		protected string _OldEND_Addess;
		protected string _OldLinkMan;
		protected string _OldENT_Telephone;
		protected string _OldFR;
		protected string _OldENT_Type;
		protected string _OldENT_Sort;
		protected string _OldENT_Grade;
		protected string _OldENT_QualificationCertificateNo;
		...
		public string OldEND_Addess
		{
			get {return _OldEND_Addess;}
			set {_OldEND_Addess = value;}
		}
		...
		public string OldENT_Type
		{
			get {return _OldENT_Type;}
			set {_OldENT_Type = value;}
		}

		public string OldENT_Sort
		{
			get {return _OldENT_Sort;}
			set {_OldENT_Sort = value;}
		}

		public string OldENT_Grade
		{
			get {return _OldENT_Grade;}
			set {_OldENT_Grade = value;}
		}

		public string OldENT_QualificationCertificateNo
		{
			get {return _OldENT_QualificationCertificateNo;}
			set {_OldENT_QualificationCertificateNo = value;}
		}
