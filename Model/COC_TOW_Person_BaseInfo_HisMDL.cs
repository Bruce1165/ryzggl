...
{
    /// <summary>
    /// 业务实体类--COC_TOW_Person_BaseInfo_HisMDL填写类描述
    /// </summary>
    [Serializable]
    public class COC_TOW_Person_BaseInfo_HisMDL
    {
        public COC_TOW_Person_BaseInfo_HisMDL()
        {
        }
