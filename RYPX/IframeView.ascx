<%@ Control Language="C#" AutoEventWireup="true" CodeFile="IframeView.ascx.cs" Inherits="WebUserControl" %>
...
<style>
    ...
    /*.if_m {
       ...
       right:19px;
        height: 30px;
        background: url(../img/red/if_m.png) repeat-x center center transparent;
    ...
    .if_l {
        ...
        height: 30px;
        left:0px;
        background: url(../img/red/if_l.png) no-repeat left center transparent;
        position: absolute;
        z-index: 99999999;
    }
    .if_r {
        ...
        height: 30px;
        right:0px;
        background: url(../img/red/if_r.png) no-repeat right center transparent;
        position: absolute;
        z-index: 99999999;
    }*/    
    .ifbord{
