<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NumberIssueChoice.aspx.cs" Inherits="ZYRYJG.Register.NumberIssueChoice" %>
                ...
                <div style="width: 99%; height: 100%; margin: 10px auto; text-align: center;">
                    ...
                    <p >
                        ...
                        &nbsp;&nbsp; 
                         ...
                         <input id="Button2" type="button" class="bt_large" value="返 回" onclick='javascript: location("NumberIssue.aspx")' />
                    </p>
                </div>
            </div>
