<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="ExamRoomAllotSC.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamRoomAllotSC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="ExamPlanSelect1">
                <UpdatedControls>
    ...
    <div class="div_out">
        <div class="dqts">
            <div style="float: left;">
                当前位置 &gt;&gt; 考务管理 &gt;&gt;
                考场管理 &gt;&gt; 实操考试管理 &gt;&gt;<strong>实操考场安排</strong>
            </div>
        </div>
        <div class="content">
            <table cellpadding="2" cellspacing="0" border="0" width="100%" id="tableMain" runat="server">
                <tr>
                    ...
                    <td align="left" style="width: 80%;">
                        <uc1:ExamPlanSelect ID="ExamPlanSelect1" runat="server" OnExamPlanSelectChange="ExamPlanSelect_Changed" />
                    </td>
                </tr>
                <tr>
                    <td valign="top" colspan="2">
                        <div style="width: 100%">
                            ...
                            <telerik:RadGrid ID="RadGridExamPlace" DataSourceID="ObjectDataSourceExamPlace" runat="server"
                                GridLines="None" AllowPaging="True" PageSize="10" AutoGenerateColumns="False"
                                Width="98%" Skin="Blue" EnableAjaxSkinRendering="false" AllowMultiRowSelection="true"
                                EnableEmbeddedSkins="false">
                                <ClientSettings EnableRowHoverStyle="true">
                                    <Selecting AllowRowSelect="true" />
                                </ClientSettings>
                                <MasterTableView CommandItemDisplay="None" DataKeyNames="ExamPlaceID,ExamPersonNum,ExamPlaceName,RoomNum"
                                    ...
                                    <PagerTemplate>
                                        <uc2:GridPagerTemple ID="GridPagerTemple2" runat="server" />
                                    </PagerTemplate>
                                </MasterTableView>
                                <SortingSettings SortToolTip="单击进行排序"></SortingSettings>
                                <StatusBarSettings LoadingText="正在读取数据" ReadyText="完成" />
                            </telerik:RadGrid>
                            <asp:ObjectDataSource ID="ObjectDataSourceExamPlace" runat="server" SelectCountMethod="SelectCount"
                                EnablePaging="True" SortParameterName="orderBy" TypeName="DataAccess.ExamPlaceDAL"
                                SelectMethod="GetList" DataObjectTypeName="Model.ExamPlaceOB">
                                <SelectParameters>
                            ...
                            <div style="padding: 8px 0px;">
                                <asp:Button ID="ButtonAllot" runat="server" Text="∨ 分配考点" CssClass="bt_large" OnClick="ButtonAllot_Click" CausesValidation="false" />&nbsp;<asp:Button
                                    ID="ButtonRecover" runat="server" Text="∧ 取消分配" CssClass="bt_large" OnClick="ButtonRecover_Click" CausesValidation="false" />
                            </div>
                            <div class="table_cx">
                                <img alt="" src="../Images/jglb.png" width="15" height="15" style="margin-bottom: -2px; padding-right: 2px;" />
                                已分配考点列表<asp:Label ID="LabelAllotHelp" runat="server" Text="" ForeColor="#ff3300"></asp:Label>
                            </div>
                            <telerik:RadGrid ID="RadGridExamPlaceAllot" DataSourceID="ObjectDataSourceExamPlaceAllot" Skin="Blue" EnableAjaxSkinRendering="false" AllowMultiRowSelection="true"
                                ...
                                <MasterTableView CommandItemDisplay="None" DataKeyNames="ExamPlaceAllotID,ExamPlaceID,ExamPlanID,Status"
                                        ...
                                        <telerik:GridTableView Name="ExamRoomAllot" DataSourceID="ObjectDataSourceExamRoomAllot"
                                            ...
                                            <EditFormSettings InsertCaption="添加考场" CaptionFormatString="编辑考场{0}信息 " CaptionDataField="ExamRoomCode"
                                                ...
                                                <FormTemplate>
                                                    <contenttemplate>
                                                <br />   
                                                        <table id="Table1" cellspacing="1" cellpadding="5" width="100%" border="0" style="padding-top: 20px;">
                                                            <tr>
                                                                <td align="right">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorExamRoomCode" runat="server" ErrorMessage="必填" Display="Dynamic"
                                    ControlToValidate="RadNumericTextBoxExamRoomCode"></asp:RequiredFieldValidator>
                                    </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="right">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="RequiredFieldValidatorPersonNumber" runat="server" ErrorMessage="必填" Display="Dynamic"
                                    ControlToValidate="RadNumericTextBoxPersonNumber"></asp:RequiredFieldValidator>
                                    </td>
                                                            </tr>
                                                            <tr>
                                                               <td align="right">
                                  ...
                                  <asp:RequiredFieldValidator ID="RequiredFieldValidatorExamStartTime" runat="server"  style="float: left;"
                                    ...
                                    <EditFormSettings CaptionFormatString="分配考场: {0}" CaptionDataField="ExamPlanName"
                                        ...
                                        <FormTemplate>
                                            <contenttemplate>
                                              <table id="Table1"  cellspacing="1" cellpadding="5" width="100%" border="0" style="padding-top: 10px; min-height:300px" >
                                                            <tr>
                                                                <td align="right">
                                                                    考点名称：
                                                                </td>
                                            ...
                                            <table style="width: 100%; padding: 10px 10px;">
                                                ...
                                                <tr><td style="text-align:center;color:darkblue">
                                                    提示：【分配考场】将覆盖原有分配结果，全新分配。【追加考场】保留原有分配结果，增加新的分配场次。
                                                    </td></tr>
                                            </table>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceExamPlaceAllot" runat="server" SelectCountMethod="SelectCount"
                                EnablePaging="True" SortParameterName="orderBy" TypeName="DataAccess.ExamPlaceAllot_OperationDAL"
                                SelectMethod="GetList" UpdateMethod="Update" DataObjectTypeName="Model.ExamPlaceAllot_OperationOB">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="filterWhereString" QueryStringField="filterWhereString"
                                        DefaultValue="" ConvertEmptyStringToNull="false" />
                                </SelectParameters>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSourceExamRoomAllot" runat="server" SelectCountMethod="SelectCount"
                                EnablePaging="True" SortParameterName="orderBy" TypeName="DataAccess.ExamRoomAllot_OperationDAL"
                                SelectMethod="GetList" UpdateMethod="Update" DeleteMethod="Delete" DataObjectTypeName="Model.ExamRoomAllot_OperationOB">
                                <SelectParameters>
                                    <asp:QueryStringParameter Name="filterWhereString" QueryStringField="filterWhereString"
                                        DefaultValue="" ConvertEmptyStringToNull="false" />
                                </SelectParameters>
                            ...
                            <div class="table_cx">
                                <img alt="" src="../Images/jglb.png" width="15" height="15" style="margin-bottom: -2px; padding-right: 2px;" />
                                随机分配准考证（注意：分配准考证后无法编辑考点、考场）
                            </div>
                            <div style="padding: 8px 20px; clear: both; float: none">
                                <div style="padding: 12px 0px; float: none;">
                                    <asp:Button ID="ButtonCreateExamCard" runat="server" Text="准考证放号" CssClass="bt_large"
                                        OnClick="ButtonCreateExamCard_Click" />&nbsp;&nbsp;
                                         <asp:Button ID="ButtonDeleteeExamCard" runat="server" Text="取消准考证放号" CausesValidation="false" CssClass="bt_maxlarge" Visible="false" OnClientClick="if(!confirm('您确定要取消准考证放号?'))return false;"
