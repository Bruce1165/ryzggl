<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="ExamRoomAllot.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamRoomAllot" %>
                    ...
                    <td valign="top" colspan="2">
                        <div style="float: right; width: 100%">
                            ...
                            <div style="padding: 8px 0px;">
                                <asp:Button ID="ButtonAllot" runat="server" Text="∨ 分配考点" CssClass="bt_large" OnClick="ButtonAllot_Click" />&nbsp;<asp:Button
                                    ID="ButtonRecover" runat="server" Text="∧ 取消分配" CssClass="bt_large" OnClick="ButtonRecover_Click" />
                            </div>
                            <div class="table_cx">
                                <img alt="" src="../Images/jglb.png" width="15" height="15" style="margin-bottom: -2px; padding-right: 2px;" />
                            ...
                            <div style="padding: 8px 0px;">
                                <asp:Button ID="ButtonCreateExamCard" runat="server" Text="准考证放号" CssClass="bt_large"
                                    OnClick="ButtonCreateExamCard_Click" />&nbsp;&nbsp;
                                         <asp:Button ID="ButtonDeleteeExamCard" runat="server" Text="取消准考证放号" CssClass="bt_maxlarge" Visible="false" OnClientClick="if(!confirm('您确定要取消准考证放号?'))return false;"
