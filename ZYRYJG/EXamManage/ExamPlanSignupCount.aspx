<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true" CodeBehind="ExamPlanSignupCount.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamPlanSignupCount" %>
        ...
        <div class="content">
            ...
            <div id="DivExamPlan" runat="server" style="width: 98%; margin: 0 auto;">
                <telerik:RadGrid ID="RadGridExamPlan" AutoGenerateColumns="False" PagerStyle-AlwaysVisible="true"
                    ...
                    <MasterTableView CommandItemDisplay="None" DataKeyNames="ExamPlanID"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn HeaderText="报名时间">
                                <ItemTemplate>
                                    <nobr><%# Convert.ToDateTime(Eval("SignUpStartDate")).ToString("yy.MM.dd") + "-" %></nobr>
                                    <nobr><%# Convert.ToDateTime(Eval("SignUpEndDate")).ToString("yy.MM.dd")%></nobr>
                                </ItemTemplate>
                            ...
                            <telerik:GridTemplateColumn HeaderText="考试时间">
                                <ItemTemplate>
                                    <%# Convert.ToDateTime(Eval("ExamStartDate")).CompareTo(Convert.ToDateTime(Eval("ExamEndDate")))==0?Convert.ToDateTime(Eval("ExamStartDate")).ToString("yy.MM.dd"):string.Format("<nobr>{0}-</nobr><nobr>{1}</nobr>",Convert.ToDateTime(Eval("ExamStartDate")).ToString("yy.MM.dd") , Convert.ToDateTime(Eval("ExamEndDate")).ToString("yy.MM.dd"))%>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridTemplateColumn>
                             <telerik:GridBoundColumn UniqueName="PersonLimit" DataField="PersonLimit" HeaderText="报名人数上限">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                           <%-- <telerik:GridBoundColumn UniqueName="PreSignupCount" DataField="PreSignupCount" HeaderText="预报名数量">
                                <HeaderStyle HorizontalAlign="Center"  />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>--%>
                             <telerik:GridBoundColumn UniqueName="SignupCount" DataField="SignupCount" HeaderText="报名数量">
                                <HeaderStyle HorizontalAlign="Center"  />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn UniqueName="UnitCheckedCount" DataField="UnitCheckedCount" HeaderText="单位确认数量">
                                <HeaderStyle HorizontalAlign="Center"  />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn UniqueName="JWCheckCount" DataField="JWCheckCount" HeaderText="建委审核数量">
                                <HeaderStyle HorizontalAlign="Center" />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                             <telerik:GridBoundColumn UniqueName="JWPassCount" DataField="JWPassCount" HeaderText="建委审核通过数量">
                                <HeaderStyle HorizontalAlign="Center"  />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                        </Columns>                       
                 ...
                 <asp:ObjectDataSource ID="ObjectDataSource2" runat="server" TypeName="DataAccess.ExamPlanDAL"
                    DataObjectTypeName="Model.ExamPlanOB" SelectMethod="GetListSingupCount" EnablePaging="true"
                    SelectCountMethod="SelectSingupCount" MaximumRowsParameterName="maximumRows" StartRowIndexParameterName="startRowIndex"
