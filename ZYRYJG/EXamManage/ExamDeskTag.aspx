<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="ExamDeskTag.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamDeskTag" %>
        ...
        <div id="DivMain" style="width: 100%; padding: 0; display: block;" runat="server">
            ...
            <div id="div_grid" style="display: block; padding-left: 66px; height: 100%" onmousemove="javascript:hideTree();">
                <div class="DivContent" id="div_tip" runat="server" style="background-image: url(../Images/mf.png);
                    ...
                    <b>使用说明：</b>
                    <br />
                    桌标用途：用于在课桌上标注考生信息。<br />
                    可以按照“考试日期”或“考试计划”生成桌标导出打印。<br />
                    从左侧考试计划列表中选择一个考试日期或考试计划查询出数据，点击“导出桌标”，保存word文档到本地进行打印；<br />
                </div>
                <div style="padding: 10px 20px; text-align: right; font-size: 12px;">
                    <asp:Button ID="ButtonPrint" runat="server" Text="导出桌标" CssClass="bt_large" OnClick="ButtonExport_Click"
                        Visible="false" />
                </div>
                ...
                <div style="padding: 10px 0px; text-align: center; font-size: 12px;">
                    <asp:Button ID="ButtonPrint1" runat="server" Text="导出桌标" CssClass="bt_large" OnClick="ButtonExport_Click"
                        Visible="false" />
                </div>
            </div>
        </div>
