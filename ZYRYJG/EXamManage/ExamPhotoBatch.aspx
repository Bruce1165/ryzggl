<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="ExamPhotoBatch.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamPhotoBatch" %>
        ...
        <div class="table_border" style="width: 750px; margin: 3px auto;">
            <div class="content">
                 <div style="width: 95%; margin: 10px auto; text-align: center; clear: left;">
                     剩余打印任务数：<label id="PrintCount" runat="server" style="color:red; font-size:18px; padding-right:20px"></label>
                    <asp:Button ID="ButtonPrint2" runat="server" Text="打 印" CssClass="button" OnClick="ButtonPrint_Click" />
                </div>
                <div id="DivContent">
