<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="ExamRoomTag.aspx.cs" Inherits="ZYRYJG.EXamManage.ExamRoomTag" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function onRequestStart(sender, args) {
                ...
                if (args.get_eventTarget().indexOf("ButtonOutputExcel") >= 0
                || args.get_eventTarget().indexOf("ButtonOutputExcel1") >= 0) {
    ...
    <div class="div_out">
        ...
        <div id="DivMain" style="width: 100%; padding: 0; display: block;" runat="server">
            ...
            <div class="jbxxbt">
                考试门标</div>
            <div id="div_grid" style="display: block; margin-left: 66px; height: 100%;" onmousemove="javascript:hideTree();">
                <div class="DivContent" id="div_tip" runat="server" style="background-image: url(../Images/mf.png);
                    background-position: 20px center; background-repeat: no-repeat; margin-top: 30px;
                    padding: 20px 20px 20px 170px; line-height: 22px; width: 60%">
                    <br />
                    <b>使用说明：</b>
                    <br />
                    门标用途：1、确定考场所在教学楼位置；2、标注每个考场的考试信息及准考证信息。<br />
                    可以按照“考试日期”或“考试计划”生成门标导出打印。<br />
                    从左侧考试计划列表中选择一个考试日期或考试计划查询出数据，点击“导出门标(word)”，保存word文档到本地进行打印；<br />
                    点击“导出列表(excel)”，保存Excel文档到本地，可以手工添加考场对应教室的楼号、楼层、教室号，再进行打印。<br />
                </div>
                <div style="padding: 10px 20px; text-align: right; font-size: 12px;">
                    <asp:Button ID="ButtonPrint" runat="server" Text="导出门标(word)" CssClass="bt_maxlarge"
                        OnClick="ButtonExport_Click" Visible="false" />&nbsp;&nbsp;<asp:Button ID="ButtonOutputExcel"
                            runat="server" Text="导出列表(excel)" CssClass="bt_maxlarge" OnClick="ButtonOutputExcel_Click"
                            Visible="false" />
                </div>
                <div style="width: 98%; margin: 0 auto;">
                    <telerik:RadGrid ID="RadGridExamResult" AutoGenerateColumns="False" runat="server"
                        ...
                        OnExcelExportCellFormatting="RadGridExamResult_ExcelExportCellFormatting">
                        <MasterTableView CommandItemDisplay="None" DataKeyNames="ExamPlanID,ExamStartDate,ExamStartTime,ExamEndTime" NoMasterRecordsText="　没有可显示的记录">
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Subject" HeaderText="考试科目">
                ...
                <div style="padding: 10px 0px; text-align: center; font-size: 12px;">
                    <asp:Button ID="ButtonPrint1" runat="server" Text="导出门标(Word)" CssClass="bt_maxlarge"
                        OnClick="ButtonExport_Click" Visible="false" />&nbsp;&nbsp;<asp:Button ID="ButtonOutputExcel1"
                            runat="server" Text="导标列表(excel)" CssClass="bt_maxlarge" OnClick="ButtonOutputExcel_Click"
                            Visible="false" />
                </div>
            </div>
        </div>
