<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="CertifManageQuery.aspx.cs" Inherits="ZYRYJG.StAnManage.CertifManageQuery" %>
    ...
    <div class="div_out">
        ...
        <div class="content">
            ...
            <div class="DivContent" id="Td3">
                【证书管理统计】是按时间段统计“首次发证、续期、京内变更、离京变更、进京变更、注销、遗失污损补办”数量。<br />
                &nbsp;&nbsp;其中“首次发证”按发证时间统计，“变更”和“续期”按最后审核决定时间统计。<br />
                &nbsp;&nbsp;输入查询时间段，如“自 2010-1-1 至 2010-12-31 ” 即可查询全年证书变化情况，不输时间表示查询所有数据。
            </div>
            <div id="Divquery" runat="server">
                <table class="bar_cx">
                    <tr>
                        <td align="right" nowrap="nowrap" style="width: 200px;">统计时间范围：自
                        </td>
                        <td align="left">
                            <telerik:RadDatePicker ID="RadDatePicker_StartDate" MinDate="01/01/1900" runat="server" Calendar-DayCellToolTipFormat="yyyy年MM月dd日"
                                Width="180px" />
                            <div class="RadPicker" style="margin-top:4px">至</div>
                            <telerik:RadDatePicker ID="RadDatePicker_EndDate" MinDate="01/01/1900" runat="server" Calendar-DayCellToolTipFormat="yyyy年MM月dd日"
                                Width="180px" />
                            
             &nbsp;&nbsp;<asp:Button ID="ButtonSearch" runat="server" Text="查 询" CssClass="bt_large" OnClick="ButtonSearch_Click" OnClientClick="changepageView()" />
                            ...
                            <telerik:RadGrid ID="RadGrid1" AutoGenerateColumns="False" runat="server" Skin="Blue"
                                ...
                                <MasterTableView CommandItemDisplay="None" NoMasterRecordsText="　没有可显示的记录" Width="100%">
                                    <Columns>
                                        ...
                                        <telerik:GridBoundColumn UniqueName="当前有效" DataField="当前有效" HeaderText="当前<br />有效">
                                            <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                            <ItemStyle HorizontalAlign="Center" />
                                        </telerik:GridBoundColumn>
