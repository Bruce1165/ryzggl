<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertifDueWarning.aspx.cs" Inherits="ZYRYJG.StAnManage.CertifDueWarning" %>
      ...
      &gt;&gt; 动态预警 &gt;&gt; <strong>证书到期预警</strong> 
        ...
        <div class="table_border" style="width:92%;margin:5px auto;">
            <div class="content">
                ...
                <div>
                    <p class="table_cx"><img src="../Images/jglb.png" width="15" height="15" style="margin-bottom:-2px;padding-right:2px;"/> 证书到期预警列表</p>
                    <div>
             ...
             <!--   <div>
                    ...
                    <div style="width:95%;margin:0 auto;padding:10px;font-size:12px;color:#5b7ba2;line-height:18px;border:1px solid #ccc;">
                        ...
                        1、东考试报名点地址：北京朝阳水碓东路18号院（北京城建学校院内） 电话：85982272 可乘公交31路、117路、419路、710路、729路、752路、754路、815路、847路、852路、988路甜水园北里下车或乘9路金台路下车或乘115路团结湖公园下车。

2、西考试报名点地址：北京海淀西四环北路137号院（田村社区服务中心院内） 电话：88111278 可乘公交61路、121路、334路、603路、996路、运通110路、运通113路、运通118路五路桥下车（西四环路西侧）即到。
