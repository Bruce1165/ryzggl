...
{
    public partial class CertifManageQuery : BasePage
    {
        ...
        protected void ButtonSearch_Click(object sender, EventArgs e)
        {
            ...
            //填充统计数据
            DataTable dtData = CertificateDAL.AnalysisCertificateManageData(RadDatePicker_StartDate.SelectedDate, RadDatePicker_EndDate.SelectedDate, null, null);
            DataRow drFind = null;
            ...
            //计算小计、合计
            System.Collections.Generic.Dictionary<string, int> sum = new Dictionary<string, int>() { { "首次", 0 }, { "当前有效", 0 }, { "续期", 0 }, { "京内变更", 0 }, { "离京变更", 0 }, { "进京变更", 0 }, { "注销", 0 }, { "补办", 0 }, { "小计", 0 } };
            ...
            RadGrid1.DataBind();
            Session["CertifManageQuery_dtBase"] = dtBase;
