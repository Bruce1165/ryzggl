<%@ Page Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="CertifCheck.aspx.cs" Inherits="ZYRYJG.RenewCertifates.CertifCheck" %>
...
<%@ Register Src="../ReportSelect.ascx" TagName="ReportSelect" TagPrefix="uc5" %>
    ...
    <div class="div_out">
        <div class="dqts">
            <div style="float: left;">
                当前位置 &gt;&gt; 从业人员证书管理 &gt;&gt;
                <asp:Label ID="LabelCheck" runat="server" Text="Label"></asp:Label>&gt;&gt; <strong>续期审查</strong>
            </div>
        </div>
        <div class="content" id="divMain" runat="server">
            <table class="bar_cx">
                ...
                <tr>
                    <td align="right" nowrap="nowrap">初审批号：
                    </td>
                    <td align="left">
                        <telerik:RadTextBox ID="RadTextBoxGetCode" runat="server" Width="97%" Skin="Default" MaxLength="20">
                        </telerik:RadTextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:RadioButtonList ID="RadioButtonListStatus" runat="server" RepeatDirection="Horizontal" Width="400px"
                            ...
                            <asp:ListItem Value="未审核" Selected="True">未审核</asp:ListItem>
                ...
                <tr>
                    <td align="right" nowrap="nowrap">汇总上报批次号：
                    </td>
                    <td align="left">
                        <uc5:ReportSelect ID="ReportSelect1" runat="server" />
                    </td>
                    ...
                    <td colspan="2" align="center">
                        ...
                        <span style="color: #999">（提示：请首先根据特定的查询条件过滤后再导出查询结果集。） </span>
                    </td>
                </tr>
            </table>
            <div class="table_cx">
                <img src="../Images/jglb.png" width="15" height="15" style="margin-bottom: -2px; padding-right: 2px;" />
                证书续期审核列表<span style="text-align: right; right: 20px; cursor: pointer; color: blue;" onclick="showCheckListHelp()">《审核时限说明》</span>
            </div>
                    ...
                    <MasterTableView NoMasterRecordsText="　没有可显示的记录"
                        ...
                        <Columns>
                            ...
                            <telerik:GridBoundColumn UniqueName="GetDate" DataField="GetDate" HtmlEncode="false"
                                DataFormatString="{0:yyyy-MM-dd}" HeaderText="初审时间">
                                <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
                            ...
                            <telerik:GridBoundColumn UniqueName="CheckDate" DataField="CheckDate" HtmlEncode="false"
                                DataFormatString="{0:yyyy-MM-dd}" HeaderText="审核时间">
                                <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                <ItemStyle HorizontalAlign="Center" Wrap="false" />
                            </telerik:GridBoundColumn>
            ...
            <div id="TableFirstCheck" runat="server" visible="false" style="width: 99%; padding-top: 20px; text-align: center; clear: both; margin: auto">
                <table id="TableEdit" runat="server" width="100%" border="0" cellpadding="5" cellspacing="1" class="table" style="text-align: center; margin: 10px auto">
                    ...
                    <tr class="GridLightBK">
                        ...
                        <td width="80%" align="left">
                            ...
                            <asp:TextBox ID="TextBoxFirstCheckRemark" runat="server" TextMode="MultiLine" Rows="3" Width="99%" MaxLength="100" Text="审核通过"></asp:TextBox>
                        </td>
                    </tr>
                    <tr class="GridLightBK">
                        <td colspan="2" align="center">
