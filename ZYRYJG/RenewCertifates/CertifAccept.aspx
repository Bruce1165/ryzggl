<%@ Page Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="CertifAccept.aspx.cs" Inherits="ZYRYJG.RenewCertifates.CertifAccept" %>
        ...
        <div class="content">
            <table class="bar_cx">
                ...
                <tr>
                    ...
                    <td align="left">
                        <telerik:RadTextBox ID="RadTextBoxApplyCode" runat="server" Width="97%" Skin="Default" MaxLength="20"
                            >
                        </telerik:RadTextBox>
                    </td>
                ...
                <tr>
                    <td align="right" nowrap="nowrap">初审状态：
                    </td>
                    <td align="left">
                        <asp:RadioButtonList ID="RadioButtonListStatus" runat="server" RepeatDirection="Horizontal"
                            ...
                            <asp:ListItem Value="未受理" Selected="True">未受理</asp:ListItem>
                            <asp:ListItem Value="退回修改">退回修改</asp:ListItem>
                            <asp:ListItem Value="初审通过">初审通过</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                ...
                <tr>
                   <td align="right" nowrap="nowrap">继续教育形式：
                    ...
                    <td align="right" nowrap="nowrap">条形码：
                    </td>
                    <td align="left">
                        <telerik:RadTextBox ID="RadTextBoxCertificateContinueID" runat="server" Width="97%" Skin="Default" MaxLength="20"
                            TextMode="Password">
                        </telerik:RadTextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="4" align="center">
                        ...
                        &nbsp;&nbsp; <span style="color: #999">（提示：请首先根据特定的查询条件过滤后再导出查询结果集。）
                        </span>
                    </td>
                </tr>
            </table>
            <div class="table_cx">
                ...
                证书续期受理列表（提示：审核后请到续期初审汇总上报页面进行汇总，打印汇总意见表，签字盖章后将扫描件上传到系统中。）
                    ...
                    <MasterTableView NoMasterRecordsText="　没有可显示的记录"
                        ...
                        <Columns>
                            ...
                            <telerik:GridTemplateColumn UniqueName="Status" HeaderText="审核状态">
                                <ItemTemplate>
                                    <span class='<%# (Eval("Status").ToString()=="已申请")?"statusWaitUnitCehck":(Eval("Status").ToString()=="退回修改")?"statusSendBack":"CheckPass"%>'>
                                        <%# (Eval("Status").ToString()=="已申请")?"未受理":
                                    (Eval("Status").ToString()=="退回修改")?"退回修改":"初审通过"%>
                                    </span>
                                </ItemTemplate>
