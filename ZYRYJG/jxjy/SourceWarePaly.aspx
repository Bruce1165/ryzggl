<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SourceWarePaly.aspx.cs" Inherits="ZYRYJG.jxjy.SourceWarePaly" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        ...
        function play()
        {
            location.replace("SourceWarePaly.aspx?o=" + kjid)
        }

        window.setInterval(function () { pause(); }, 15000);
    </script>
</head>
<body>
