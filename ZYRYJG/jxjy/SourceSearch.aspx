<%@ Page Title="考试计划选择" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="SourceSearch.aspx.cs" Inherits="ZYRYJG.jxjy.SourceSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript">
            function returnToParent(SourceID, SourceName) {
                var oArg = new Object();
                oArg.SourceID = SourceID;
                oArg.SourceName = SourceName;
