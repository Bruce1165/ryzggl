<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="UnitTrainPlan.aspx.cs" Inherits="ZYRYJG.jxjy.UnitTrainPlan" %>
        ...
        <div class="div_out">
            ...
            <div class="content">
                <table class="cx" width="98%" border="0" align="center" cellspacing="5">
                    <tr>
                        <td align="right" nowrap="nowrap" width="11%">培训计划名称：
                        </td>
                        <td align="left" width="39%">
                            <telerik:RadTextBox ID="RadTextBoxPackageTitle" runat="server" Width="97%" Skin="Default" onkeydown="ButtonSearchClick(event);">
                            </telerik:RadTextBox>
                        </td>
                       <td align="right">
                           培训专业方向：
                    ...
                    <tr>
                          <td align="right" width="11%" nowrap="nowrap">发布状态：
                        </td>
                        <td align="left" width="39%">
                        ...
                        <MasterTableView CommandItemDisplay="Top" DataKeyNames="PackageID,Status,PackageTitle" NoMasterRecordsText="　没有可显示的记录">
                            <CommandItemTemplate>
                                <div class="grid_CommandBar">
                                    <input type="button" value=" " class="rgAdd" onclick="javascript: SetIfrmSrc('UnitTrainPlanEdit.aspx');" />
                                    <nobr onclick="javascript:SetIfrmSrc('UnitTrainPlanEdit.aspx');" class="grid_CmdButton">添加</nobr>
                                </div>
                            </CommandItemTemplate>
                            <Columns>                              
                                <telerik:GridBoundColumn HeaderText="行号" UniqueName="RowNum" DataField="RowNum">
                                 ...
                                 <telerik:GridTemplateColumn HeaderText="培训专业方向" UniqueName="PostTypeName">
                                    <ItemTemplate>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Edit">
                                    <ItemTemplate>
                                        <span class="link_edit" onclick='javascript:SetIfrmSrc("UnitTrainPlanEdit.aspx?o=<%# Eval("PackageID") %>");'>编辑</span>
                                    </ItemTemplate>
                                </telerik:GridTemplateColumn>
