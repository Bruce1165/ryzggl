...
{
    public partial class PackageEdit : BasePage
    {
        protected override string CheckVisiteRgihtUrl
        {
            get
            {
                return "PackageMgr.aspx";
            }
        }
        ...
        {
            QueryParamOB q = new QueryParamOB();
            q.Add(string.Format("PackageID = {0}", string.IsNullOrEmpty(Request["o"]) == false?Request["o"]:"0"));  
        ...
        protected void ComputSelectPeriod()
        {
            ...
            catch (Exception ex)
            {
                ...
                UIHelp.WriteErrorLog(Page, "计选择课程总时长失败！", ex);
                return;
            }
        }
