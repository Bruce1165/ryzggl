<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RYSBView.aspx.cs" Inherits="ZYRYJG.County.RYSBView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="div_out">
            ...
            <div id="main" runat="server" class="content" style="padding: 20px 5px 30px 5px;">
                <p id="p_CheckUnit" runat="server" style="color: red">
                    <asp:Label ID="LabelCheckUnit" runat="server" Text="" ForeColor="Red"></asp:Label>
                </p>
            ...
            <table id="divRtn" style="width: 90%; padding: 20px; text-align: center; line-height: 40px;">
                <tr>
                    <td>
