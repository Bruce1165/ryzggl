<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeLook.aspx.cs" Inherits="ZYRYJG.County.NoticeLook" %>
                    ...
                    <div style="width: 95%; height: 100%; margin: 10px auto; text-align: center;">
                        <table>
                            <tr>
                                ...
                                <td style="width: 30%" align="right">
                                    <input id="Button1" type="button" class="button" value="添 加" onclick='javascript: SetIfrmSrc("NoticeChoice.aspx");' />
                                </td>
                            </tr>
                        </table>
                        <div style="width: 98%; text-align: center; clear: both;">
                                    ...
                                    <Columns>
                                        ...
                                        <telerik:GridTemplateColumn UniqueName="Edit" HeaderText="操作">
                                            <ItemTemplate>
                                                ...
                                                &nbsp;
                                                <input id="Button1" runat="server" type="button" value="修改" class="link" onclick='<%# string.Format("javascript:SetIfrmSrc(\"NoticeChoice.aspx?01={0}&02={1}&03=xg\");return false;",Eval("NoticeCode"),Eval("ApplyType"))%>' visible='<%#Eval("Notice").ToString()=="未公告" %>' />
                                                &nbsp;
                                        <asp:Button ID="Button3" runat="server" Text="公告" CssClass="link" CommandName="report" OnClientClick="javascript:if(confirm('您确认要公告吗？')==false) return false;" Visible='<%#Eval("Notice").ToString()=="未公告" %> ' />
                                            ...
                                            <asp:Button ID="Button5" runat="server" Text="取消" CssClass="link" CommandName="Cancelreport" OnClientClick="javascript:if(confirm('您确认要取消重新选择吗？')==false) return false;" Visible='<%#Eval("Notice").ToString()=="未公告" %> ' />
                                                &nbsp;                                          
                                         <input id="Button6" runat="server" type="button" value="详细" class="link" onclick='<%# string.Format("javascript:SetIfrmSrc(\"NoticeChoice.aspx?01={0}&02={1}&03=xx\");return false;",Eval("NoticeCode"),Eval("ApplyType"))%>' visible='<%#Eval("Notice").ToString()=="已公告" %>' />
                                            </ItemTemplate>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.ApplyMDL"
                                SelectMethod="GetNoticeList" TypeName="DataAccess.ApplyDAL"
