<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChoiceBusinessSummarizing.aspx.cs" Inherits="ZYRYJG.County.ChoiceBusinessSummarizing" %>
            ...
            <div style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                ...
                <div class="content">
                    <div class="step">
                        ...
                        <div id="step_区县审查" runat="server" class="stepItem lgray step_w80 green" style="width: 100px">业务员汇总></div>
                        <div id="step_已上报" runat="server" class="stepItem lgray " >业务员上报（先导出、领导签字、扫描、上报扫描件）</div>
                    ...
                    <div class="DivContent" id="Td3">
                        1、按查询条件筛选待汇总数据（二级和二级临时必须分别汇总）；<br />
                    ...
                    <div style="width: 100%; margin: 10px auto; text-align: center; clear: both;">
                        <table id="tableSearch" runat="server" width="98%" border="0" align="center" cellspacing="1">
                            <tr id="TrPerson" runat="server">
                                ...
                                <td align="right" width="85px" style="font-weight:bold;">注册等级：
                                </td>
                        ...
                        <div style="width: 100%; clear: both; position: relative;">
                            ...
                            EnableEmbeddedSkins="False" PagerStyle-AlwaysVisible="true" OnDataBound="RadGridADDRY_DataBound">
                                ...
                                <ItemTemplate>
                                      ...
                                      <%# (Eval("ApplyType").ToString() =="延期注册"||Eval("ApplyType").ToString() =="遗失补办"||Eval("ApplyType").ToString() =="增项注册")?"":Eval("CheckZSSD") ==DBNull.Value?"<div class=\"flag_red pointer\" onclick='javascript:alert(\"尚未比对!\")'>&nbsp;</div>": Eval("CheckZSSD").ToString()=="1"?string.Format("<div class=\"flag_red pointer\" onclick='javascript:SetIfrmSrc(\"ZSSDDetail.aspx?z={0}\");'>&nbsp;</div>", Eval("PSN_RegisterNo")):""%>
                                      <%# (Eval("ApplyType").ToString() =="注销"||Eval("ApplyType").ToString() =="遗失补办"||Eval("ApplyType").ToString() =="增项注册")?"": Eval("CheckXSL") ==DBNull.Value?"<div class=\"flag_green pointer\" onclick='javascript:alert(\"尚未比对!\");'>&nbsp;</div>":Eval("CheckXSL").ToString()=="1"?"<div class=\"flag_green pointer\" onclick='javascript:alert(\"无企业资质\");'>&nbsp;</div>":""%>
                                     ...
                                     <%--   <%# Eval("CheckZSSD") ==DBNull.Value?"<div class=\"flag_red pointer\" onclick='javascript:alert(\"尚未比对!\")'>&nbsp;</div>": Eval("CheckZSSD").ToString()=="1"?string.Format("<div class=\"flag_red pointer\" onclick='javascript:SetIfrmSrc(\"ZSSDDetail.aspx?z={0}\");'>&nbsp;</div>", Eval("PSN_RegisterNo")):""%>
                                        <%# Eval("CheckXSL") ==DBNull.Value?"<div class=\"flag_green pointer\" onclick='javascript:alert(\"尚未比对!\");'>&nbsp;</div>":Eval("CheckXSL").ToString()=="1"?"<div class=\"flag_green pointer\" onclick='javascript:alert(\"无企业资质\");'>&nbsp;</div>":""%>
                                   --%>
                                </ItemTemplate>
                                <HeaderStyle HorizontalAlign="Left" />
