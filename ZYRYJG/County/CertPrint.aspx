<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertPrint.aspx.cs" Inherits="ZYRYJG.County.CertPrint" %>
...
<head runat="server">
    ...
    <script src="../Scripts/Public.js?v=1.1" type="text/javascript"></script>
            ...
            <div class="table_border" style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                ...
                <div class="content">
                    ...
                    <asp:Button ID="ButtonNext" runat="server" Text="下一条" CssClass="button" Visible="False"
                        ...
                        &nbsp;&nbsp;
                    <%--<asp:Button ID="BtnReturn2" runat="server" Text="返 回" CssClass="button" OnClick="BtnReturn2_Click" />--%>
                    <input id="BtnReturn3" type="button" class="button" value="返 回" onclick="javascript: hideIfam(true);" />
                   
                    </div>
                    <div style="width: 95%; margin: 10px auto; text-align: center;">
                        <asp:Label ID="LabelPage" runat="server" Text="" Font-Bold="true" Visible="false"></asp:Label>
                    </div>
                    <div id="divPhoto" runat="server" style="z-index:9998;width: 18.2cm; margin: 0; margin-left: auto; margin-right: auto; text-align: left; vertical-align: top; vertical-align: middle; background: url(../images/cert.jpg) no-repeat left top; background-size: cover;">
                        
                    </div>
                   <%-- <div style="position:absolute; top:-5cm;z-index:9999">--%>
                     <div  style="position:absolute; top:74%;left:30%;z-index:9999;font-size:18px;font:bold;"> <asp:Label ID="lbl_PSN_RegisterCertificateNo" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></div>
                </div>
            </div>
        </div>
