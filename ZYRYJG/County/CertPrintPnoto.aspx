<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CertPrintPnoto.aspx.cs" Inherits="ZYRYJG.County.CertPrintPnoto" %>
        ...
        <div class="div_out">
            <div class="table_border" style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                ...
                <div class="content">
                    ...
                    <div id="divPhoto" runat="server" style="width: 18.2cm; margin: 0; margin-left: auto; margin-right: auto; text-align: left; vertical-align: top; vertical-align: middle; background: url(../images/cert.jpg) no-repeat left top; background-size: cover;">
                    </div>
                </div>
            </div>
        </div>
