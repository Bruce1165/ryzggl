<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnLockDetailed.aspx.cs" Inherits="ZYRYJG.County.UnLockDetailed" %>
    ...
    <div class="div_out">
        <div id="div_top" class="dqts">
              <div style="float: left; width: 244px;">
                    当前位置 &gt;&gt;证书锁定 &gt;&gt;<strong>证书解锁</strong>
                </div>
        </div>
       <div class="table_border" style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
            <div class="content">
                <div style="background: url(../Images/unlock.png) left center no-repeat; background-size:12%; ">
         ...
         <table  border="1"  style="text-align:center;width:100%; border-collapse:collapse;border:1px solid  #999"  >
                    <tr id="TrPerson" runat="server">
                        <td style="width:140px">
                             <asp:Label ID="Lbl_SFZH" runat="server" Text="Label" Visible="false"></asp:Label>
                        </td>
                    ...
                    <tr><td></td>
                        ...
                        <td  style="text-align:left;" >
                        <asp:Label ID="Lbl_UnLockPeople" runat="server" Text="Label"></asp:Label>
                        </td>
                        <td style="text-align:right" class="auto-style2">
                         &nbsp;类型：</td>
                        <td style="text-align:left;">
                             <asp:Label ID="Lbl_lx" runat="server" Text="Label"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr><td></td>
                     ...
                     <%--   锁定截止日期：--%>
                        ...
                        <td   style="text-align:left;colspan="3">
                             ...
                             <asp:Label ID="Lbl_UnLockTime" runat="server" Text="Label"></asp:Label>
                        </td>
                    ...
                    <tr>
                        <td></td>
                    <td style="text-align:right;height:50px" class="auto-style1" >解锁原因说明：</td> 
