<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublicityChoice.aspx.cs" Inherits="ZYRYJG.County.PublicityChoice" %>
            ...
            <div  style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                ...
                <div class="content">
                    ...
                    <div style="width: 95%; height: 100%; margin: 10px auto; text-align: center;">
                        ...
                        <div style="width: 98%; text-align: left; margin: 12px 0 12px 0; color: blue;">请勾选要公示的人员，点击“立即公示”上报到建委，点击“保存”先保存勾选结果，以后公示。</div>
                        <div style="width: 100%; clear: both; position: relative;">
                            <telerik:RadGrid ID="RadGridADDRY" runat="server" Height="300"
                                GridLines="None" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" PageSize="1000"
                                ...
                                <MasterTableView NoMasterRecordsText=" 没有可显示的记录" DataKeyNames="ApplyID,PublicMan,ConfirmResult,PSN_Level,ApplyType" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left">
                                    <Columns>
                                        <telerik:GridTemplateColumn UniqueName="SelectAllColumn">
                                            ...
                                            <ItemTemplate>
                                              <%--  <asp:CheckBox ID="CheckBox1" CssClass="ck" runat="server" onclick='checkBoxClick(this.checked);' Checked='<%#Eval("PublicCode")==DBNull.Value?false:true %>' />--%>
                    ...
                    <div style="clear: both; position: relative; width: 100%; text-align: center; margin: 8px 0">
                        ...
                        &nbsp;&nbsp; 
                            <asp:Button ID="ButtonReport" runat="server" Text="立即公示" CssClass="bt_large" OnClick="ButtonReport_Click" />
                        &nbsp;&nbsp; 
