    ...
    <form id="form2" runat="server">
        ...
        <div class="div_out">
            ...
            <div class="step">
                ...
                <div id="step_已受理" runat="server" class="stepItem lgray">市建委受理></div>
            ...
            <div class="DivContent" id="Td3">
                ...
                5、<b style="color: red">请申请人登录“全国工程质量安全监管信息平台公共服务门户”- 安全生产管理人员考核合格证书信息栏目查询，原证书信息应为“办理转出”状态方可提交进京申请。</b>
            </div>
            <div class="content">
                        ...
                        <div id="divWorker" runat="server" visible="false" style="padding: 30px 20px 50px 20px; width: auto">
                            ...
                            <asp:Button ID="ButtonSave" Text='保 存' runat="server" CssClass="button" OnClick="ButtonSave_Click"></asp:Button>&nbsp;
                             <asp:Button ID="ButtonExport" runat="server" Text="导出打印" CssClass="bt_large" OnClick="ButtonExport_Click"
                                 Enabled="False" />&nbsp;
                        <asp:Button ID="ButtonExit" Text="取消申报" runat="server" CssClass="bt_large" Enabled="false" OnClientClick="return myconfirm(this);"
