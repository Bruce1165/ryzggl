                    ...
                    <div style="width: 66%; float: left; clear: left">
                        ...
                        <table id="TableEdit" runat="server" width="95%" border="0" cellpadding="5" cellspacing="1"
                            ...
                            <tr class="GridLightBK">
                                <td colspan="5" class="barTitle">申请表</td>
                            </tr>
                            <tr class="GridLightBK">
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td colspan="4">
                                    <telerik:RadTextBox ID="RadTextBoxOldUnitName" runat="server" Width="90%" Skin="Default" MaxLength="100">
                                    </telerik:RadTextBox>
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td colspan="2">
                                    <telerik:RadTextBox ID="RadTextBoxUnitName" runat="server" Width="90%" Skin="Default" MaxLength="100">
                                    </telerik:RadTextBox>
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td>
                                    <telerik:RadTextBox ID="RadTextBoxConferUnit" runat="server" Width="97%" Skin="Default" MaxLength="100">
                                    </telerik:RadTextBox>
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td>
                                    <telerik:RadTextBox ID="RadTextBoxCertificateCode" runat="server" Width="97%" Skin="Default" MaxLength="50">
                                    </telerik:RadTextBox>
