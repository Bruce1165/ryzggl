<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyQuerySLR.aspx.cs" Inherits="ZYRYJG.CertifManage.ApplyQuerySLR" %>
        ...
        <div class="div_out">
            <div class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;从业人员证书管理 &gt;&gt;安全生产三类人员&gt;&gt;<strong>申办业务查询</strong>
                </div>
            </div>
            <div class="content">
                            ...
                            <td align="left">&nbsp;申报事项：
                                 <telerik:RadComboBox ID="RadComboBoxPSN_RegisteType" runat="server" Width="100" AutoPostBack="true" OnSelectedIndexChanged="RadComboBoxPSN_RegisteType_SelectedIndexChanged">
                                     <Items>
                                         ...
                                         <telerik:RadComboBoxItem Text="进京变更" Value="进京变更" />
                                         <telerik:RadComboBoxItem Text="离京变更" Value="离京变更" />
                                         <telerik:RadComboBoxItem Text="注销" Value="注销" />
                                         <telerik:RadComboBoxItem Text="证书续期" Value="证书续期" />
                                         <telerik:RadComboBoxItem Text="A本增发" Value="A本增发" />
                                         <telerik:RadComboBoxItem Text="C1、C2合并" Value="C1、C2合并" />
                                     </Items>
                                 </telerik:RadComboBox>
                                &nbsp;&nbsp;申报进度：
                                 <telerik:RadComboBox ID="RadComboBoxApplyStatus" runat="server" Width="120">
                                     <Items>
                                         ...
                                         <telerik:RadComboBoxItem Text="已编号" Value="已编号" />
                                     </Items>
                                 </telerik:RadComboBox>
                                &nbsp;&nbsp;
