<%@ Page Title="" Language="C#" MasterPageFile="~/RadControls.Master" AutoEventWireup="true"
    CodeBehind="CertifMoreConfirm.aspx.cs" Inherits="ZYRYJG.CertifManage.CertifMoreConfirm" %>
    ...
    <div class="div_out">
        <div class="dqts">
            <div style="float: left;">
                当前位置 &gt;&gt; 证书管理 &gt;&gt;三类人员&gt;&gt; <strong>A本增发决定</strong>
            </div>
        </div>
        <div class="content">
                ...
                <tr>
                    ...
                    <td align="left">
                        <asp:RadioButtonList ID="RadioButtonListApplyStatus" runat="server" RepeatDirection="Horizontal"
                            ...
                            <asp:ListItem Value="已审核" Selected="True">未决定</asp:ListItem>
                            <asp:ListItem Value="已决定">决定通过</asp:ListItem>
                            <asp:ListItem Value="退回修改">退回修改</asp:ListItem>
                        </asp:RadioButtonList>
                    </td>
                    <td align="right" nowrap="nowrap">决定时间：
                    </td>
                    <td align="left">
            ...
            <div style="width: 98%; margin: 0 auto;">
                <telerik:RadGrid ID="RadGrid1" AllowPaging="True" SortingSettings-SortToolTip="单击进行排序" PagerStyle-AlwaysVisible="true"
                    runat="server" AutoGenerateColumns="False" AllowSorting="True" GridLines="None" OnPageIndexChanged="RadGrid1_PageIndexChanged" OnDataBound="RadGrid1_DataBound"
                    ...
                    <MasterTableView DataKeyNames="ApplyID" NoMasterRecordsText="没有可显示的记录">
                        <Columns>
                            ...
                            <telerik:GridBoundColumn HeaderText="受理日期" UniqueName="CheckDate" DataField="CheckDate"
                              ...
                              <telerik:GridBoundColumn HeaderText="决定日期" UniqueName="ConfirmDate" DataField="ConfirmDate"
                                DataFormatString="{0:yyyy-MM-dd}">
                                <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                <ItemStyle HorizontalAlign="Center" />
                            </telerik:GridBoundColumn>
            ...
            <div id="anniudiv" runat="server">
                <asp:Button ID="ButtonConfirm" runat="server" Text="批量审核" CssClass="bt_large" OnClick="ButtonConfirm_Click" />
            </div>
        </div>
    </div>
