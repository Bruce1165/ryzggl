<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinningInfor.aspx.cs" Inherits="ZYRYJG.PersonnelFile.WinningInfor" %>
      ...
      &gt;&gt; <strong>人员获奖信息</strong> 
        ...
        <div class="table_border" style="width:92%;margin:5px auto;">
            <div class="content">
                        ...
                        <div class="subxboxcontent">
                             <table width="95%" border="0" align="center" cellspacing="5">                                
                                  <tr>
                                    ...
                                    <td width="38%" nowrap="nowrap"><asp:TextBox ID="Name" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>                                    </td>
                                    <td width="12%" align="right" nowrap="nowrap">证件号码：</td>
                                    <td  nowrap="nowrap"><asp:TextBox ID="TextBox3" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>
                                    </td>
                                  </tr> 
                                    <tr>
                                    <td align="right" nowrap="nowrap">获奖类型： </td>
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="TextBox4" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>
                                    </td>
                                    <td align="right" nowrap="nowrap">获奖时间：</td>
                ...
                <div>
                    <p class="table_cx"><img src="../Images/jglb.png" width="15" height="15" style="margin-bottom:-2px;padding-right:2px;"/> 人员获奖信息列表</p>
                    <div>
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="获奖类型" DataField="HJTYPE" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn> 
                            
                            <asp:BoundColumn HeaderText="获奖名称" DataField="HJMC" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>
                            
                            <asp:BoundColumn HeaderText="颁奖单位" DataField="DWMC" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>                              
                            
                            <asp:BoundColumn HeaderText="获奖时间" DataField="DATE" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>  
                        </Columns>
                    </asp:DataGrid>--%>
                    <table cellpadding="3" cellspacing="1" border="0" width="95%" class="table" align="center">
                        <tr class="GridHead">
                          ...
                          <td nowrap="nowrap"align="center">获奖类型</td>				  
                          <td nowrap="nowrap"  align="center">获奖名称</td>
                          <td  align="center" nowrap="nowrap">颁奖单位</td>
                          <td align="center" nowrap="nowrap">获奖时间</td>
                      </tr>
