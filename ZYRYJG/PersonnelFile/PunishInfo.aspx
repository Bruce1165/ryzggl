<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PunishInfo.aspx.cs" Inherits="ZYRYJG.PersonnelFile.PunishInfo" %>
      ...
      &gt;&gt; <strong>人员处罚信息</strong> 
        ...
        <div class="table_border" style="width:92%;margin:5px auto;">
            <div class="content">
                    ...
                    <div class="blue_center" style="width:95%;margin:0 auto;">
                        ...
                        <div class="subxboxcontent">
                             <table width="95%" border="0" align="center" cellspacing="5">                                
                                  <tr>
                                    <td align="right" nowrap="nowrap" width="12%">姓名： </td>
                                    <td nowrap="nowrap" width="40%"><asp:TextBox ID="Name" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>
                                    </td>
                                    <td align="right" nowrap="nowrap" width="12%">证件号码：</td>
                                    <td  nowrap="nowrap"><asp:TextBox ID="TextBox3" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>
                                    </td>
                                  </tr> 
                                    <tr>
                                    <td align="right" nowrap="nowrap" width="10%">处罚类型： </td>
                                    <td nowrap="nowrap">
                                         <asp:DropDownList ID="DropDownList1" runat="server" Width="92%" Height="21px" CssClass="texbox">
                                        <asp:ListItem>请选择</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    <td align="right" nowrap="nowrap">处罚时间：</td>
                                    <td  nowrap="nowrap"><asp:TextBox ID="TextBox2" runat="server" Cssclass="texbox" style="width:90%"></asp:TextBox>
                                    </td>
                                  </tr> 
                                  <tr>
                ...
                <div>
                    <p class="table_cx"><img src="../Images/jglb.png" width="15" height="15" style="margin-bottom:-2px;padding-right:2px;"/> 人员处罚信息列表</p>
                    <div>
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn HeaderText="处罚类型" DataField="CFTYPE" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn> 
                            
                            <asp:BoundColumn HeaderText="处罚分值" DataField="CFFZ" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>
                            
                            <asp:BoundColumn HeaderText="处罚金额" DataField="CFJE" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>                              
                            
                            <asp:BoundColumn HeaderText="处罚机关" DataField="CFJG" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>   
							 <asp:BoundColumn HeaderText="处罚时间" DataField="CFDATE" 
                                 HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Middle" >
                            </asp:BoundColumn>       
                        </Columns>
                    </asp:DataGrid>--%>
                    <table cellpadding="3" cellspacing="1" border="0" width="95%" class="table" align="center">
                        <tr class="GridHead">
                          ...
                          <td nowrap="nowrap"align="center">处罚类型</td>				  
                          <td nowrap="nowrap"  align="center">处罚分值</td>
                          <td  align="center" nowrap="nowrap">处罚金额</td>
                          <td align="center" nowrap="nowrap">处罚机关</td>
                          <td align="center" nowrap="nowrap">处罚时间</td>
                      </tr>
