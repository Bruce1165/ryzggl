...
{
    public partial class YJZJS : BasePage
    {
        ...
        protected void ButtonSearch_Click(object sender, EventArgs e)
        {
            ...
            ViewState["YJZJS_QueryParamOB"] = q;
        ...
        protected void ButtonExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            QueryParamOB q = ViewState["YJZJS_QueryParamOB"] as QueryParamOB;
            ...
            try
            {
                ...
                CommonDAL.OutputXls(MyWebConfig.DBOutputPath + Server.MapPath(saveFile).Substring(1), "DBO.View_JZS_OneLevel", q.ToWhereString(), "Fid", colHead, colName);
            }
            catch (Exception ex)
            {
                UIHelp.WriteErrorLog(Page, "导出一级注册建造师证书信息失败！", ex);
                return;
            }

            List<ResultUrl> url = new List<ResultUrl>();
            url.Add(new ResultUrl("一级注册建造师下载", saveFile));
