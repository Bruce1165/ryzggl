<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YJZJS_LS.aspx.cs" Inherits="ZYRYJG.Unit.YJZJS_LS" %>
        ...
        <div class="div_out">
            ...
            <div class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;综合查询 &gt;&gt;人员证书查询 &gt;&gt;<strong>一级临时建造师</strong>
                </div>
            </div>
            <div class="content">
                <table class="cx" width="100%" border="0" align="center" cellspacing="1">
                    <tr id="TrPerson" runat="server">
                        ...
                        <td width="60px" align="right" nowrap="nowrap">状态：
                        </td>
                    ...
                    <telerik:RadGrid ID="RadGridQY" runat="server"
                        ...
                        <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="PSN_RegisteProfession" HeaderText="注册专业及有效期">
                                    <ItemTemplate>
                                        <%# Eval("PSN_RegisteProfession") %>（<%# Convert.ToDateTime(Eval("PSN_CertificateValidity")).ToString("yyyy-MM-dd") %>）
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridTemplateColumn>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Edit">
                                    <ItemTemplate>
                                        <span class="link_edit" onclick=' javascript:SetIfrmSrc("YJZJS_LSDetail.aspx?o=<%# Utility.Cryptography.Encrypt(Eval("Fid").ToString()) %>"); '>详细</span>
                                    </ItemTemplate>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.COC_ONE_Person_BaseInfoMDL"
                    SelectMethod="GetListView_JZS_OneTempLevel" TypeName="DataAccess.COC_ONE_Person_BaseInfoDAL"
                    SelectCountMethod="SelectCountView_JZS_OneTempLevel" EnablePaging="true"
