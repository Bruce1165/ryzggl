<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyAddItem.aspx.cs" Inherits="ZYRYJG.Unit.ApplyAddItem" %>
                ...
                <div class="content">
                    ...
                    <div style="width: 100%; margin: 10px auto; text-align: center; overflow: hidden;">
                        ...
                        <div style="width: 66%; float: left; clear: left">
                            <table runat="server" id="Tablezjhm" visible="false" class="detailTable" border="0" cellpadding="5" cellspacing="1" style="text-align: center;">
                                <tr class="GridLightBK">
                                    <td class="barTitle">选择一个要增项的专业                               
                                   
                                    </td>
                                </tr>
                                <tr class="GridLightBK">
                                    <td>
                                        <telerik:RadGrid ID="RadGridHZSB" runat="server" ShowHeader="true" CellPadding="0" CellSpacing="0"
                                            ...
                                            <MasterTableView NoMasterRecordsText=" 没有可用于增项的专业" DataKeyNames="XM,ZJHM,ZYLB,ZGZSBH,QDNF,QFSJ" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left">
                                                <Columns>
                                                    ...
                                                    <telerik:GridBoundColumn UniqueName="ZYLB" DataField="ZYLB" HeaderText="专业类别">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn UniqueName="ZGZSBH" DataField="ZGZSBH" HeaderText="资格证书编号/管理号">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </telerik:GridBoundColumn>
                                                    <telerik:GridBoundColumn UniqueName="QFSJ" DataField="QFSJ" HeaderText="签发日期">
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </telerik:GridBoundColumn>
                                                </Columns>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="ButtonSaveZjh" runat="server" Text="确 定" CssClass="button" CausesValidation="false" OnClick="ButtonSaveZjh_Click" />
                                    </td>
                                </tr>
                            </table>
                            <table runat="server" id="EditTable" class="detailTable" style="border-collapse: collapse;">
                                <tr class="GridLightBK">
                               ...
                               <%-- <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="formItem_1" colspan="3" style="padding: 0; border-collapse: collapse;">
                                        <table width="100%" style="border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItem_1">
                                                    <telerik:RadTextBox ID="RadTextBoxPSN_CertificateValidity1" runat="server" CssClass="readonly" Width="98%" MaxLength="10" ReadOnly="true"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItem_1">
                                                ...
                                                <td class="formItem_1">
                                                    <telerik:RadTextBox ID="RadTextBoxPSN_CertificateValidity2" runat="server" CssClass="readonly" Width="98%" MaxLength="10" ReadOnly="true"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="formItem_1">
                                                ...
                                                <td class="formItem_1">
                                                    <telerik:RadTextBox ID="RadTextBoxPSN_CertificateValidity3" runat="server" CssClass="readonly" Width="98%" MaxLength="10" ReadOnly="true"></telerik:RadTextBox>
                                            ...
                                            <tr>
                                                ...
                                                <td class="formItem_1">
                                                    <telerik:RadTextBox ID="RadTextBoxPSN_CertificateValidity4" runat="server" CssClass="readonly" Width="98%" MaxLength="10" ReadOnly="true"></telerik:RadTextBox>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr class="GridLightBK">
                                    <td colspan="4" class="barTitle">增项信息</td>
                                </tr>
                                <tr>
                                    <td class="infoHead">申请增项注册专业：
                                    </td>
                                    <td colspan="3" class="formItem_1" style="padding: 0;">
                                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                                            <tr>
                                                <td class="formItem_1 vc ac bold" rowspan="2" width="6%">增项专业</td>
                                                <td class="formItem_1 vc ac bold" rowspan="2" width="26%">考试合格证明编号</td>
                                                <td class="formItem_1 vc ac bold" rowspan="2" width="24%">签发日期</td>
                                                <td class="formItem_1 vc ac bold line200" colspan="2" width="44%">继续教育情况</td>
                                            </tr>
                                            <tr>
                                                <td class="formItem_1 bold line200 ac">必修（学时）</td>
                                                <td class="formItem_1 bold line200 ac">选修（学时）</td>
                                            </tr>
                                            <tr>
                                                <td class="formItem_1">

                                                    <asp:Label ID="LabelAddItem1" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                                    <asp:Label ID="LabelExamCode1" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                                    <asp:Label ID="LabelExamDate1" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                            ...
                                            <tr>
                                                <td class="formItem_1">
                                                    <asp:Label ID="LabelAddItem2" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                                    <asp:Label ID="LabelExamCode2" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                                    <asp:Label ID="LabelExamDate2" runat="server" Text=""></asp:Label>
                                                </td>
                                                <td class="formItem_1">
                                ...
                                <tr class="GridLightBK" id="trFuJan" runat="server" visible="false">
                                    <td colspan="4">
                                        ...
                                        <div class="fujian">
                                            学历证书扫描件：<span class="link" onclick="javascript:tips_pop('<%=Model.EnumManager.FileDataType.学历证书扫描件%>','学历证书扫描件','','<%=ApplyID%>')">选择文件</span><span class="tishi">（要求：上传证书扫描件原件、jpg格式图片,最大500K）</span>
                                        </div>
                                        ...
                                        <div class="fujian">
                                            <span style="color: Red">* </span>增项注册告知承诺书：<span class="link" onclick="javascript:tips_pop('<%=Model.EnumManager.FileDataType.增项注册告知承诺书%>','增项注册告知承诺书','','<%=ApplyID%>')">选择文件</span><span class="tishi">（要求：上传增项注册告知承诺书原件、jpg格式图片,最大500K）</span>
                                        </div>
                                        <div class="fujian" style="display: none">
                            ...
                            <div id="divGR" visible="false" runat="server" style="width: 100%; padding-top: 20px; text-align: center; clear: both;">
                                ...
                                &nbsp;&nbsp;<asp:Button ID="ButtonOutput" runat="server" Text="导出申请表及增项注册告知承诺书" CssClass="bt_large" OnClick="ButtonOutput_Click" OnClientClick="javascript:alert('导出的文件包含申请表以及增项注册告知承诺书,请在对应的位置分别上传扫描件（注意：不得对导出的申请表、增项注册告知承诺书，内容进行任何形式的编辑或修改，否则按提供虚假资料申报注册处理。)');" Enabled="false" />
                                ...
                                <table id="Table3" runat="server" width="100%" border="0" cellpadding="5" cellspacing="1" class="table" style="text-align: center; margin: 10px auto">
                                    ...
                                    <tr class="GridLightBK">
                                     ...
                                     <tr class="GridLightBK">
                                        ...
                                        <td width="80%" align="left">
                                            <asp:TextBox ID="TextBoxConfirmRemark" runat="server" TextMode="MultiLine" Rows="3" Width="99%" Text="决定通过"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr class="GridLightBK">
                                        <td colspan="2" align="center">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#<%= RadioButtonListDecide.ClientID%> input").each(function () {
                $(this).click(function () {
                    var TextBoxConfirmRemark = $("#<%= TextBoxConfirmRemark.ClientID%>");

                    if ($(this).val() == "通过") {

                        TextBoxConfirmRemark.val("决定通过");
                    }
                    else {
                        TextBoxConfirmRemark.val("决定未通过");
                    }
                });
            });
        })
