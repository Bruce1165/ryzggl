<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplyFirstDetail.aspx.cs" Inherits="ZYRYJG.Unit.ApplyFirstDetail" %>
            ...
            <div class="table_border" style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                <div id="div_top" class="dqts">
                    <div style="float: left;">
                        <img alt="" src="../Images/ts.gif" width="17" height="11" />当前位置 &gt;&gt;申报事项 &gt;&gt;<strong>初始注册</strong>
                    </div>
                </div>
                <div class="content">
                    <p class="jbxxbt">
                    ...
                    <div style="width: 95%; margin: 10px auto; text-align: center;">
                        <table runat="server" id="SetTable" width="95%" border="0" cellpadding="5" cellspacing="1" class="table" style="text-align: center; margin: 10px auto">
                            <tr class="GridLightBK">
                                <td colspan="3" style="color: #434343; background-color: #E4E4E4; font-weight: bold;">基本信息</td>
                                <td style="color: #434343; background-color: #E4E4E4; font-weight: bold; text-align: right">申请单号：<asp:Label ID="LabelApplyCode" runat="server" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr class="GridLightBK">
                            ...
                            <tr class="GridLightBK">
                                <td colspan="4" style="color: #434343; background-color: #E4E4E4; font-weight: bold;">继续教育情况（逾期注册）</td>
                            </tr>
                            <tr class="GridLightBK">
                                <td width="15%" align="right">必修课（学时）：</td>
                                <td width="35%" align="left">
                                    <telerik:RadTextBox ID="RadTextBoxBiXiu" runat="server"></telerik:RadTextBox>
                                </td>
                                <td width="15%" align="right">选修课（学时）：</td>
                                <td width="35%" align="left">
                                    <telerik:RadTextBox ID="RadTextBoxXuanXiu" runat="server"></telerik:RadTextBox>
                                </td>
                            </tr>

                            <tr class="GridLightBK">
                                <td colspan="4" style="color: #434343; background-color: #E4E4E4; font-weight: bold;">其他</td>
                            </tr>
                            <tr class="GridLightBK">
                                <td width="15%" align="right">资质考试合格专业情况：</td>
                                <td width="35%" align="left">
                                    <telerik:RadTextBox ID="RadTextBoxExamInfo" runat="server"></telerik:RadTextBox>
                                </td>
                                <td width="15%" align="right">其他注册情况：</td>
                                <td width="35%" align="left">
                                    <telerik:RadTextBox ID="RadTextBoxOtherCert" runat="server"></telerik:RadTextBox>
                                </td>
                            </tr>
                            <tr class="GridLightBK">
                                <td width="15%" align="right">与其它类执业师是否注册在同一个单位：</td>
                                <td width="35%" align="left">是：<asp:RadioButton ID="RadioButton1" runat="server" GroupName="zy" />
                                    否：<asp:RadioButton ID="RadioButton2" runat="server" Checked="true" GroupName="zy" />
                                </td>
                                <td width="15%" align="right">工程业绩情况：</td>
                                <td width="35%" align="left">
                                    <telerik:RadTextBox ID="RadTextBoxMainJob" runat="server" TextMode="MultiLine" Width="250px"></telerik:RadTextBox>
                                </td>
                            </tr>
                        </table>
