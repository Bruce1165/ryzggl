<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZCJLSDetail.aspx.cs" Inherits="ZYRYJG.Unit.ZCJLSDetail" %>
                    ...
                    <div style="width: 95%; margin: 10px auto; text-align: center;">
                        <table runat="server" id="EditTable" width="100%" border="0" cellpadding="5" cellspacing="1" class="table" style="text-align: center;">
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td class="formItem_1">
                                    <asp:TextBox ID="TextBoxPSN_RegisterCertificateNo" runat="server" CssClass="textEdit" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                            ...
                            <tr class="GridLightBK">
                                ...
                                <td class="formItem_1">
                                    <asp:TextBox ID="TextBoxPSN_CertificationDate" runat="server" CssClass="textEdit" MaxLength="8" ReadOnly="true"></asp:TextBox>
                                </td>
                                <td class="infoHead">证书有效期：
                                </td>
                                <td class="formItem_1">
                                    <asp:TextBox ID="TextBoxPSN_CertificateValidity" runat="server" CssClass="textEdit" MaxLength="8" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                            <tr class="GridLightBK">
                                ...
                                <td class="formItem_1">
                                    <asp:TextBox ID="TextBoxPSN_RegisteProfession" runat="server" CssClass="textEdit" MaxLength="50" ReadOnly="true"></asp:TextBox>
                                </td>
                                 <td class="infoHead">执业资格证书编号：
                                </td>
                                <td class="formItem_1">
                                    <asp:TextBox ID="TextBox执业资格证书编号" runat="server" CssClass="textEdit" MaxLength="8" ReadOnly="true"></asp:TextBox>
                                </td>
                            </tr>
                             <tr class="GridLightBK">
