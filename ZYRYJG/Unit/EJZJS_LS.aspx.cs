...
{
    public partial class EJZJS_LS : BasePage
    {
        ...
        protected void ButtonSearch_Click(object sender, EventArgs e)
        {
            ...
            ViewState["EJZJS_LS_QueryParamOB"] = q;
        ...
        protected void ButtonExportToExcel_Click(object sender, EventArgs e)
        {
            ...
            QueryParamOB q = ViewState["EJZJS_LS_QueryParamOB"] as QueryParamOB;
            ...
            {
                UIHelp.WriteErrorLog(Page, "导出二级临时注册建造师证书信息失败！", ex);
                return;
            }

            List<ResultUrl> url = new List<ResultUrl>();
            url.Add(new ResultUrl("二级临时注册建造师下载", saveFile));
