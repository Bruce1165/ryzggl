<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZCZJS.aspx.cs" Inherits="ZYRYJG.Unit.ZCZJS" %>
        ...
        <div class="div_out">
            ...
            <div class="content">
                        ...
                        <td width="12%" align="right" nowrap="nowrap">
                            <telerik:RadComboBox ID="RadComboBoxIten" runat="server">
                                <Items>
                                    ...
                                    <telerik:RadComboBoxItem Text="身份证号" Value="SFZH" />
                                    <telerik:RadComboBoxItem Text="注册证号" Value="ZCZH" />
                                    <telerik:RadComboBoxItem Text="聘用单位" Value="PYDW" />
                                    <telerik:RadComboBoxItem Text="所在区县" Value="Region" />
                                </Items>
                            </telerik:RadComboBox>
                        </td>
                    ...
                    <telerik:RadGrid ID="RadGridQY" runat="server"
                        ...
                        <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left">
                            <Columns>
                                ...
                                <telerik:GridBoundColumn UniqueName="Region" DataField="Region" HeaderText="所在区县" Visible="false">
                                ...
                                <telerik:GridBoundColumn UniqueName="SFZH" DataField="SFZH" HeaderText="身份证号">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn UniqueName="PYDW" DataField="PYDW" HeaderText="聘用单位">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn UniqueName="ZCZH" DataField="ZCZH" HeaderText="注册证号">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn UniqueName="ZY" DataField="ZY" HeaderText="注册专业">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridBoundColumn UniqueName="ZSYXQ" DataField="ZSYXQ" HeaderText="证书有效期" HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd}">
                                    <HeaderStyle HorizontalAlign="Left" />
                                    <ItemStyle HorizontalAlign="Left" />
                                </telerik:GridBoundColumn>
                                <telerik:GridTemplateColumn UniqueName="Edit">
                                    <ItemTemplate>
                                        <span class="link_edit" onclick=' javascript:SetIfrmSrc("ZCZJSDetail.aspx?o=<%# Utility.Cryptography.Encrypt(Eval("SFZH").ToString()) %>"); '>详细</span>
                                    </ItemTemplate>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.COC_TOW_Person_BaseInfoMDL"
                    SelectMethod="GetList" TypeName="DataAccess.jcsjk_zjsDAL"
