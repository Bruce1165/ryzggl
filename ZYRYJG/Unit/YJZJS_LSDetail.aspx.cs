...
{
    public partial class YJZJS_LSDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                COC_ONE_Temporary_Person_BaseInfoMDL o = COC_ONE_Temporary_Person_BaseInfoDAL.GetObject(Utility.Cryptography.Decrypt(Request["o"]));
                if (o != null)
                {
                    ...
                    ImgCode.Src = UIHelp.ShowFile(UIHelp.ShowFaceImage(o.PSN_CertificateNO));
                    ...
                    sql = @"select  distinct p.PSN_RegistePermissionDate,
                            ...
                            from [COC_ONE_Temporary_Person_BaseInfo] p
