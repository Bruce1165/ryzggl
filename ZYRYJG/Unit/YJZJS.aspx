<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YJZJS.aspx.cs" Inherits="ZYRYJG.Unit.YJZJS" %>
        ...
        <div class="div_out">
            ...
            <div class="content">
                        ...
                        <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left"
                            ...
                            <Columns>
                               ...
                               <%-- <telerik:GridTemplateColumn UniqueName="Edit">
                                    <ItemTemplate>
                                        <span class="link_edit" onclick=' javascript:SetIfrmSrc("YJZJSDetail.aspx?o=<%# Utility.Cryptography.Encrypt(Eval("Fid").ToString()) %>"); '>详细</span>
                                    </ItemTemplate>
                ...
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.COC_ONE_Person_BaseInfoMDL"
                    SelectMethod="GetListView_JZS_OneLevel" TypeName="DataAccess.COC_ONE_Person_BaseInfoDAL"
                    SelectCountMethod="SelectCountView_JZS_OneLevel" EnablePaging="true"
