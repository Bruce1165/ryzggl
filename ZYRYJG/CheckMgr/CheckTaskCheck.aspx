<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckTaskCheck.aspx.cs" Inherits="ZYRYJG.CheckMgr.CheckTaskCheck" %>
        ...
        <div class="div_out">
            <div class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;综合监管 &gt;&gt;<strong>监管反馈复审</strong>
                </div>
            </div>
                        ...
                        <telerik:RadGrid ID="RadGridTask" runat="server"
                            ...
                            <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="LastReportTime" DataField="LastReportTime" HeaderText="个人上报截止时间" HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd}">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="WorkerUnReportCount" HeaderText="个人未反馈">
                                        <ItemTemplate>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="UnAcceptCount" HeaderText="区县驳回">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonAcceptBackCount" CommandName="AcceptBackCount" runat="server" Style="display: block"><%#Eval("AcceptBackCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="UnCheckCount" HeaderText="待市级复审">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonUnCheckCount" CommandName="UnCheckCount" runat="server" Style="display: block;background-color:#DCDCDC"><%#Eval("UnCheckCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="CheckCount" HeaderText="市级复审通过">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonCheckCount" CommandName="CheckCount" runat="server" Style="display: block;"><%#Eval("CheckCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="CheckBackCount" HeaderText="市级复审未通过">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonCheckBackCount" CommandName="CheckBackCount" runat="server" Style="display: block"><%#Eval("CheckBackCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                        ...
                        <telerik:RadGrid ID="RadGridCheckFeedBack" runat="server"
                            ...
                            <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="WorkerCertificateCode" DataField="WorkerCertificateCode" HeaderText="证件号码" Visible="false">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                        <ItemStyle HorizontalAlign="Left" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="CheckLimit" HeaderText="复审时限(工作日)">
                                        <ItemTemplate>
                                            <%# formatCheckList(Eval("WorkerRerpotTime"),Eval("AcceptTime"),Eval("DataStatusCode"))%>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                        <ItemStyle HorizontalAlign="Center" Wrap="false" />
                                    </telerik:GridTemplateColumn>
                                      <telerik:GridBoundColumn UniqueName="CheckTime" DataField="CheckTime" HeaderText="复审时间" HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd}">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
