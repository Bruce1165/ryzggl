<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckTaskAccept.aspx.cs" Inherits="ZYRYJG.CheckMgr.CheckTaskAccept" %>
        ...
        <div class="div_out">
            <div class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;综合监管 &gt;&gt;<strong>监管反馈审查</strong>
                </div>
            </div>
                            ...
                            <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Center"
                                ...
                                <Columns>
                                   ...
                                   <telerik:GridTemplateColumn UniqueName="DataCount" HeaderText="记录总量">
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="WorkerReportCount" HeaderText="已反馈数量">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonWorkerReportCount" CommandName="WorkerReportCount" runat="server" Style="display: block"><%#Eval("WorkerReportCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="UnAcceptCount" HeaderText="待审查数量">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonUnAcceptCount" CommandName="UnAcceptCount" runat="server" Style="display: block;background-color:#DCDCDC"><%#Eval("UnAcceptCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="AcceptCount" HeaderText="已审审查量">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButtonAcceptCount" CommandName="AcceptCount" runat="server" Style="display: block"><%#Eval("AcceptCount") %></asp:LinkButton>
                                        </ItemTemplate>
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridTemplateColumn>
                                    <telerik:GridTemplateColumn UniqueName="AcceptBackCount" HeaderText="已驳回数量">
                                        <ItemTemplate>
                            ...
                            <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Center"
                                ...
                                <Columns>
                                    ...
                                    <telerik:GridBoundColumn UniqueName="Unit" DataField="Unit" HeaderText="注册单位" >
                                     ...
                                     <telerik:GridBoundColumn UniqueName="Country" DataField="Country" HeaderText="所属区"  Visible="false">
                                        <HeaderStyle HorizontalAlign="Center" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                                    ...
                                    <telerik:GridTemplateColumn UniqueName="CheckLimit" HeaderText="审核时限(工作日)">
                                     ...
                                     <telerik:GridBoundColumn UniqueName="AcceptTime" DataField="AcceptTime" HeaderText="审查时间" HtmlEncode="false" DataFormatString="{0:yyyy-MM-dd}">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>
                                     <telerik:GridBoundColumn UniqueName="AcceptResult" DataField="AcceptResult" HeaderText="审查结果">
                                        <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                                        <ItemStyle HorizontalAlign="Center" />
                                    </telerik:GridBoundColumn>  
