<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zjsApplyListUnitCancel.aspx.cs" Inherits="ZYRYJG.zjs.zjsApplyListUnitCancel" %>
        ...
        <div class="div_out">
            <div class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;二级造价工程师注册 &gt;&gt;<strong>申请强制注销</strong>
                </div>              
            </div>
            <div class="content">               
                        ...
                        <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Edit" HeaderText="操作">
                                    <ItemTemplate>                                    
                                        <span class="link_edit" onclick='javascript:SetIfrmSrc("zjsApplyCancel.aspx?o=<%# Utility.Cryptography.Encrypt(Eval("PSN_ServerID").ToString()) %>&a=<%# Eval("ApplyID")==DBNull.Value?"":Utility.Cryptography.Encrypt(Eval("ApplyID").ToString()) %>")'>
