<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zjsNoticeChoice.aspx.cs" Inherits="ZYRYJG.zjs.zjsNoticeChoice" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <div style="width: 99%; margin: 5px auto; padding-bottom: 30px;">
                <div id="div_top" class="dqts">
                    <div style="float: left;">
                        当前位置 &gt;&gt;造价工程师注册管理 &gt;&gt;公告 &gt;&gt;<strong>选择要公告的审批记录</strong>
                    </div>
                </div>
                <div class="content">
                    <div style="width: 95%; height: 100%; margin: 10px auto; text-align: center;">
                        ...
                        <div style="width: 98%; text-align: left; margin: 12px 0 12px 0; color: blue;">请勾选要的人公告员，点击“保存”存储公告结果，经检查确认无误有再公示。</div>
                        <div style="width: 100%; clear: both; position: relative;">
                            <telerik:RadGrid ID="RadGridADDRY" runat="server" Height="300"
                                ...
                                <MasterTableView NoMasterRecordsText=" 没有可显示的记录" DataKeyNames="ApplyID,NoticeMan" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left">
                                    <Columns>
        ...
        <script type="text/javascript">
            function checkBoxAllClick(checkBoxAllClientID) {
                ...
                if (Chks.length) {
                    for (i = 0; i < Chks.length; i++) {
                        if (Chks[i].type == "checkbox") { Chks[i].checked = ifSelect; }
                    }
                }
                else if (Chks) {
                    if (Chks.type == "checkbox") { Chks.checked = ifSelect; }
                }
            }
            ...
            $(function () {
                $("input").each(function () { $(this).click(function () { GetSelectCount(); }); });
            });
        </script>
    </form>
</body>
