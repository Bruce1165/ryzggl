<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zjsCertInfo.aspx.cs" Inherits="ZYRYJG.zjs.zjsCertInfo" %>
        ...
        <div class="div_out">
            <div id="div_top" class="dqts">
                <div style="float: left;">
                    当前位置 &gt;&gt;人员证书查询 &gt;&gt;<strong>二级造价工程师</strong>
                </div>
            </div>
            <div class="content">
                ...
                <table runat="server" id="Table1" width="100%" border="0" cellpadding="5" cellspacing="0" class="table" style="text-align: center;">
                    <tr class="GridLightBK">
                        <td colspan="4" class="barTitle">企业基本信息</td>
                    </tr>
                    <tr class="GridLightBK">
                    ...
                    <tr class="GridLightBK">
                        <td colspan="4" class="formItem_1">
                            <telerik:RadGrid ID="RadGridHis" runat="server"
                                ...
                                Width="100%" Skin="Blue" EnableAjaxSkinRendering="False" EnableEmbeddedSkins="False" PagerStyle-AlwaysVisible="true" BorderColor="#dddddd">
                                ...
                                <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left"
                                    DataKeyNames="">
                                    <Columns>
                                        <telerik:GridBoundColumn UniqueName="PSN_RegistePermissionDate" DataField="PSN_RegistePermissionDate" HeaderText="注册时间" HtmlEncode="false" DataFormatString="{0:yyyy.MM.dd}">
                    ...
                    <tr class="GridLightBK">
                        <td colspan="4" class="formItem_1">
                            <telerik:RadGrid ID="RadGridLock" runat="server" GridLines="None" AllowPaging="True" Font-Size="16px"
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.LockZJSMDL"
                                SelectMethod="GetList" TypeName="DataAccess.LockZJSDAL" SelectCountMethod="SelectCount"
            ...
            <div style="width: 95%; margin: 10px auto; text-align: center;"> <input id="ButtonReturn" type="button" value="返 回" class="button" onclick="javascript: hideIfam();" /></div>
        </div>
    </form>
</body>
</html>
