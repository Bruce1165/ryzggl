<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="zjsApplyFirst.aspx.cs" Inherits="ZYRYJG.zjs.zjsApplyFirst" %>
        ...
        <div class="div_out">
            ...
            <div class="content">
                ...
                <table class="cx" width="98%" border="0" align="center" cellspacing="5">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            &nbsp;<input id="ButtonRenew" runat="server" visible="false" type="button" value="发起初始注册" class="bt_large" onclick='javascript: SetIfrmSrc("zjsApplyFirstAdd.aspx"); ' />
                ...
                <div style="width: 99%; margin: 8px auto;">
                        ...
                        <MasterTableView NoMasterRecordsText=" 没有可显示的记录" CommandItemDisplay="None" CommandItemStyle-HorizontalAlign="Left"
                            ...
                            <Columns>
                                ...
                                <telerik:GridTemplateColumn UniqueName="Edit">
                                    <ItemTemplate>
                                        <span class="link_edit" onclick=' javascript:SetIfrmSrc("zjsApplyFirstAdd.aspx?a=<%# Utility.Cryptography.Encrypt(Eval("ApplyID").ToString()) %>"); '>详细</span>
                                     <%# Eval("ApplyStatus").ToString() == "未申报"||Eval("ApplyStatus").ToString() == "已驳回"?string.Format("<span class=\"link_edit\" onclick=' javascript:SetIfrmSrc(\"zjsApplyFirstAdd.aspx?a={0}\"); '>提交</span>",Utility.Cryptography.Encrypt(Eval("ApplyID").ToString())):Eval("ApplyStatus").ToString() == "已申报"?string.Format("<span class=\"link_edit\" onclick=' javascript:SetIfrmSrc(\"zjsApplyFirstAdd.aspx?a={0}\"); '>撤销</span>",Utility.Cryptography.Encrypt(Eval("ApplyID").ToString())):"" %>  
                                        <span class="link_edit" onclick=' javascript:SetIfrmSrc("zjsApplyFirstAdd.aspx?a=<%# Utility.Cryptography.Encrypt(Eval("ApplyID").ToString()) %>"); '>打印</span>
                                    </ItemTemplate>
                                    <HeaderStyle HorizontalAlign="Center" Wrap="false" />
                    ...
                    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Model.zjs_ApplyFirstMDL"
                        SelectMethod="GetListView" TypeName="DataAccess.zjs_ApplyFirstDAL"
